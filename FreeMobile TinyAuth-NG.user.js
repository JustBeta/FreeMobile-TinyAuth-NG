...
//    var label = document.querySelector("#content>span");
    var label = document.getElementById("content").querySelectorAll("span");
    if (label) {
        label[0].style.display = "none";
//        label.style.display = "none";
    }
    var buttonsContainer = document.getElementById("content").querySelectorAll("div");
    if (buttonsContainer) {
...
//    }
    var connect = document.querySelector("#form_connect");
    if (connect) {
        connect.style.display = "block";
    }
    var ident_txt_identifiant = document.querySelector("#ident_txt_identifiant");
    if (ident_txt_identifiant) {
        ident_txt_identifiant.style.display = "none";
    }
    var ident_pos = document.querySelector("#ident_pos");
    if (ident_pos) {
        ident_pos.style.display = "none";
    }
    var ident_login = document.querySelector("#ident_login");
    if (ident_login) {
        ident_login.style.display = "block";
    }
    var btAideVocale = document.querySelector("#btAideVocale");
    if (btAideVocale) {
        btAideVocale.style.display = "none";
    }
};
...
//        label.style.display = "block";
    ...
    var buttonsContainer = document.getElementById("content").querySelectorAll("div");
    if (buttonsContainer) {
        buttonsContainer[0].style.display = "block";
    }
//    var buttonsContainer = document.querySelector(".ident_chiffre2");
//    if (buttonsContainer) {
...
//    }
    ...
    var ident_txt_identifiant = document.querySelector("#ident_txt_identifiant");
    if (ident_txt_identifiant) {
        ident_txt_identifiant.style.display = "block";
    }
    var ident_pos = document.querySelector("#ident_pos");
    if (ident_pos) {
        ident_pos.style.display = "block";
    }
    var ident_login = document.querySelector("#ident_login");
    if (ident_login) {
        ident_login.style.display = "none";
    }
    var btAideVocale = document.querySelector("#btAideVocale");
    if (btAideVocale) {
        btAideVocale.style.display = "block";
    }
};
...
//    contentHTML += '<img src="http://ilatumi.org/tinyauth-freemobile/version.php?v='+version+'" alt="Test de version en cours …" style="vertical-align: middle;" /></a>';
    ...
    document.getElementById("togglePanel").addEventListener("click", function () {
        if (document.getElementById("content").querySelectorAll("div")[0].style.display == "none") {
